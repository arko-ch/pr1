...
import { FileTypes, FileCategories } from '../../../services/propertyService';
...
/* import StateHelper from '../../../../app/services/stateHelper';
 import $modal from '../../../../app/services/modal';  -- rawi1217*/
...
const addFileWasabi = file => {
  ...
  propertyIdFromURL = propertyIdFromURLArray[propertyIdFromURLArray.length - 1];
      ...
      <div className="p-4">
        <Row className="mb-2">
          ...
          <Col md={9}>
            ...
            */}
            <StyledDropZone onDrop={addFileWasabi} />
          </Col>
        </Row>
