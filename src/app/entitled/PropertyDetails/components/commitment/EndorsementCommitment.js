...
const EndorsementCommitment = ({ dataEndorseCommitment, tableClass }) => {
  const renderedData = dataEndorseCommitment.map((data, index) => (
    <Fragment key={index}>
      <PropertyRow>
        <td>
          <PropertySelect>
...
export default EndorsementCommitment;
